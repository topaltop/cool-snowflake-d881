...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cool-snowflake-d881
```

A live public deployment of this template is available at [https://cool-snowflake-d881.templates.workers.dev](https://cool-snowflake-d881.templates.workers.dev)
